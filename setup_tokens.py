...
TOKENS = [
    ("OKTA_DEV_API_TOKEN",  "DEV  (https://dev-your-org.okta.com)"),
    ("OKTA_STG_API_TOKEN",  "STG  (https://staging-your-org.okta.com)"),
    ("OKTA_PROD_API_TOKEN", "PROD (https://your-org.okta.com)"),
]
